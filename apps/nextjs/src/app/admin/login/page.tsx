...
export default function LoginPage() {
  ...
  return (
    ...
    >
      ...
      {/*  </>*/}
      {/*</Link>*/}
      <CardContainer className="inter-var" data-oid="gf-0shd">
        <CardBody
        ...
        >
          ...
          <CardItem translateZ="100" className="mt-4 w-full" data-oid="kcccim_">
            <Image
          ...
          >
            ...
            >
              {isAuth0Loading ? (
                ...
                <Icons.Key className="mr-2 h-4 w-4" data-oid="9dp39vd" />
              )}{" "}
              Auth0
            </button>
          </div>
