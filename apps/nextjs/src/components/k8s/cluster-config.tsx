...
export function ClusterConfig({ cluster, params: { lang } }: ClusterProps) {
  ...
  return (
    <Form {...form} data-oid="l_rnu91">
      <form onSubmit={form.handleSubmit(onSubmit)} data-oid="9g3fx44">
        <Card data-oid="2sbb6dj">
          <CardHeader data-oid="xbtf5r2">
            <CardTitle data-oid="g6e49uq">Create cluster</CardTitle>
            <CardDescription data-oid="ob64u1w">
              Deploy your new k8s cluster in one-click.
            </CardDescription>
          </CardHeader>
          <CardContent className="w-2/3 space-y-6" data-oid="___:y72">
            <div className="grid w-full items-center gap-4" data-oid="lmpvl5m">
              <div className="flex flex-col space-y-1.5" data-oid="9e831w.">
                <FormField
                  control={form.control}
                  name="name"
                  render={({ field }) => (
                    <FormItem data-oid="9g4t6:b">
                      <FormLabel data-oid="mg:jqw4">Name</FormLabel>
                      <FormControl data-oid="br5m30m">
                        <Input
          ...
          <CardContent className="w-2/3 space-y-6" data-oid="9ls_fg6">
            <div className="grid w-full items-center gap-4" data-oid="y7c2cb6">
              <div className="flex flex-col space-y-1.5" data-oid="bgm8l.1">
                <FormField
                  control={form.control}
                  name="location"
                  render={() => (
                    <FormItem data-oid="t.l1cmt">
                      <FormLabel data-oid="k-p0tq.">Region</FormLabel>
                      <FormControl data-oid="ztn_10w">
                        <Controller
                          control={form.control}
                          name="location"
                          render={({ field }) => (
                            <Select
                              ...
                              data-oid="w4qn2c_"
                            >
                              <SelectTrigger data-oid="m.oheiy">
                                <SelectValue
                                  placeholder="Select a region"
                                  data-oid="lb9z..3"
                                />
                              </SelectTrigger>
                              <SelectContent data-oid="qkrv:-r">
                                <SelectGroup data-oid="91n_lfb">
                                  <SelectLabel data-oid="lox6b5b">
                                    Select Region
                                  </SelectLabel>
                                  <SelectItem value="China" data-oid="l_wkc.i">
                                    China
                                  </SelectItem>
                                  <SelectItem
                                    value="Hong Kong"
                                  ...
                                  <SelectItem value="Tokyo" data-oid="s1.akaq">
                                    Tokyo
                                  </SelectItem>
                                  <SelectItem
                                    value="Singapore"
          ...
          <CardContent className="w-3/4 space-y-6" data-oid="2b.x7w.">
            <div className="grid w-full items-center gap-4" data-oid="mn16y5y">
              <div className="flex flex-col space-y-1.5" data-oid="m4lc2-7">
                <Label htmlFor="name" data-oid="d13ciag">
                  MarketPlace
                </Label>
                <Tabs defaultValue="Architecture" data-oid="u2tb4_1">
                  <TabsList
                    className="grid w-full grid-cols-3"
                    data-oid="600mi.l"
                  >
                    <TabsTrigger value="Architecture" data-oid="js:p5l_">
                      Architecture
                    </TabsTrigger>
                    <TabsTrigger value="password" data-oid="lyuny1w">
                      CI/CD
                    </TabsTrigger>
                    <TabsTrigger value="Monitoring" data-oid="949i4tk">
                      Monitoring
                    </TabsTrigger>
                  </TabsList>
                  <TabsContent
                    ...
                    data-oid="_ook-x_"
                  >
                    <Card className=" mb-4 mr-1" data-oid="e40o7wh">
                      <CardHeader data-oid="pfzz.v4">
                        <div className="flex " data-oid="55b3hse">
                          <svg
                            className="h-8 w-12 "
                            role="img"
                            data-oid="2v1w.qs"
                          ...
                          <CardTitle data-oid="207_w6g">
                            Kubernetes Dashboard
                          </CardTitle>
                        </div>

                        <CardDescription data-oid="3wg2:l0">
                          UI for managing K8S clusters.
                        </CardDescription>
                      </CardHeader>
                      <CardContent data-oid="9nzks.8">
                        <div data-oid="nv01-l:">
                          <Label htmlFor="version" data-oid="jbgw4v6">
                            Version
                          </Label>
                          <Input
                            id="version"
                    ...
                    <Card className=" mx-1 mb-4" data-oid="3mosdgl">
                      <CardHeader data-oid="yk6as5.">
                        <div className="flex " data-oid="bztm.2l">
                          <svg
                            className="h-8 w-12 "
                            role="img"
                            data-oid="la6.u6-"
                          ...
                          <CardTitle data-oid="bbu:65i">
                            Istio Gateway
                          </CardTitle>
                        </div>
                        <CardDescription data-oid="hpvap5n">
                          Service Mesh for K8S clusters.
                        </CardDescription>
                      </CardHeader>
                      <CardContent data-oid="4:b3um4">
                        <div data-oid="9z4k38-">
                          <Label htmlFor="version" data-oid="..j14::">
                            Version
                          </Label>
                          <Input
                            id="version"
                    ...
                    <Card className=" mx-1 mb-4" data-oid="pzst39a">
                      <CardHeader data-oid="8v.w-h6">
                        <div className="flex " data-oid="kcd1n2i">
                          <svg
                            className="h-8 w-12 "
                          ...
                          <CardTitle data-oid="zg:i69r">Cert Manager</CardTitle>
                        </div>
                        <CardDescription data-oid="9jg1_a7">
                          k8s certificate management
                        </CardDescription>
                      </CardHeader>
                      <CardContent data-oid="s3qwv.6">
                        <div data-oid="kd2fop2">
                          <Label htmlFor="version" data-oid="mapk8jb">
                            Version
                          </Label>
                          <Input
                            id="version"
                    ...
                    <Card className=" mb-4 ml-1" data-oid="954:fk6">
                      <CardHeader data-oid="m1ymha0">
                        <div className="flex " data-oid="8n.45mm">
                          <svg
                            className="h-8 w-12 "
                            viewBox="0 0 16 16"
                            data-oid="tbre75v"
                          ...
                          <CardTitle data-oid="-iec-2."> Vault</CardTitle>
                        </div>
                        <CardDescription data-oid="ljg5y0t">
                          protecting secrets and sensitive data.
                        </CardDescription>
                      </CardHeader>
                      <CardContent data-oid="r0wzry7">
                        <div data-oid="llmajf_">
                          <Label htmlFor="version" data-oid="zx20661">
                            Version
                          </Label>
                          <Input
                            id="version"
                    ...
                    <Card className=" mb-4 mr-1 " data-oid="kbb_d44">
                      <CardHeader data-oid="-:9.16w">
                        <div className="flex items-start" data-oid="-m6tft7">
                          <svg
                            className="h-8 w-12 "
                            role="img"
                            data-oid=".1:84:a"
                          ...
                          <CardTitle data-oid="elrkb7_">Minio </CardTitle>
                        </div>
                        <CardDescription data-oid="ya5k23e">
                          S3 compatible object storage server.
                        </CardDescription>
                      </CardHeader>
                      <CardContent data-oid="ylywuzr">
                        <div data-oid="5ywcch_">
                          <Label htmlFor="version" data-oid="ggf3siw">
                            Version
                          </Label>
                          <Input
                            id="version"
                    ...
                    <Card className="invisible mx-1 mb-4" data-oid="mzb6.-6" />
                    <Card className="invisible mx-1 mb-4" data-oid="l.xxerp" />
                    <Card className="invisible mb-4 ml-1" data-oid="cmp-wkb" />
                  </TabsContent>
                  <TabsContent value="password" data-oid="exebxxs">
                    <Card data-oid="2a7:i:b">
                      <CardHeader data-oid="y:c40tc">
                        <CardTitle data-oid="zm-:36v">Password</CardTitle>
                        <CardDescription data-oid="i7iz3yo">
                          Change your password here. After saving, you`&apos;`ll
                          be logged out.
                        </CardDescription>
                      </CardHeader>
                      <CardContent className="space-y-2" data-oid="0mgu4j2">
                        <div className="space-y-1" data-oid="qcufffy">
                          <Label htmlFor="current" data-oid="rofpmqy">
                            Current password
                          </Label>
                          <Input
                            id="current"
                        ...
                        <div className="space-y-1" data-oid="ebc6p5v">
                          <Label htmlFor="new" data-oid="uoutqwp">
                            New password
                          </Label>
                          <Input id="new" type="password" data-oid="jlnc3bj" />
                        </div>
                      </CardContent>
                      <CardFooter data-oid="nllhd:-">
                        <Button data-oid="99w-xp4">Save password</Button>
                      </CardFooter>
                    </Card>
                  </TabsContent>
                </Tabs>
          ...
          <div className="w-2/3 space-y-6 p-6 pt-0" data-oid=".yic_:y">
            <Button type="submit" disabled={_isSaving} data-oid="y69:635">
              {_isSaving && (
                <Icons.Spinner
