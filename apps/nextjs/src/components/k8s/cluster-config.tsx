...
export function ClusterConfig({ cluster, params: { lang } }: ClusterProps) {
  ...
  return (
    <Form {...form} data-oid="uc2sj6u">
      <form onSubmit={form.handleSubmit(onSubmit)} data-oid="0yixpc2">
        <Card data-oid="oa9xa_s">
          <CardHeader data-oid="mwej6l0">
            <CardTitle data-oid="ci2kvin">Create cluster</CardTitle>
            <CardDescription data-oid="6:u1:d0">
              Deploy your new k8s cluster in one-click.
            </CardDescription>
          </CardHeader>
          <CardContent className="w-2/3 space-y-6" data-oid="_k_.gce">
            <div className="grid w-full items-center gap-4" data-oid="q:rxfrc">
              <div className="flex flex-col space-y-1.5" data-oid="1_qxm:b">
                <FormField
                  control={form.control}
                  name="name"
                  render={({ field }) => (
                    <FormItem data-oid="7xyq.0f">
                      <FormLabel data-oid="5wmh-.1">Name</FormLabel>
                      <FormControl data-oid="s_jg1zk">
                        <Input
          ...
          <CardContent className="w-2/3 space-y-6" data-oid="bhzblyf">
            <div className="grid w-full items-center gap-4" data-oid="_30-6lz">
              <div className="flex flex-col space-y-1.5" data-oid=".itb5-4">
                <FormField
                  control={form.control}
                  name="location"
                  render={() => (
                    <FormItem data-oid="hxpnq_y">
                      <FormLabel data-oid="a:8pne5">Region</FormLabel>
                      <FormControl data-oid="1j4dlqf">
                        <Controller
                          control={form.control}
                          name="location"
                          render={({ field }) => (
                            <Select
                              ...
                              data-oid="rmx2gck"
                            >
                              <SelectTrigger data-oid="gdqnh_6">
                                <SelectValue
                                  placeholder="Select a region"
                                  data-oid="eetq:eb"
                                />
                              </SelectTrigger>
                              <SelectContent data-oid="xbana8g">
                                <SelectGroup data-oid="w26uu2t">
                                  <SelectLabel data-oid="i4m1ztj">
                                    Select Region
                                  </SelectLabel>
                                  <SelectItem value="China" data-oid="idlq.z5">
                                    China
                                  </SelectItem>
                                  <SelectItem
                                    value="Hong Kong"
                                  ...
                                  <SelectItem value="Tokyo" data-oid="11p2k1_">
                                    Tokyo
                                  </SelectItem>
                                  <SelectItem
                                    value="Singapore"
          ...
          <CardContent className="w-3/4 space-y-6" data-oid="ekp_6cq">
            <div className="grid w-full items-center gap-4" data-oid="zi0oxlx">
              <div className="flex flex-col space-y-1.5" data-oid="3rktd19">
                <Label htmlFor="name" data-oid="qgus4a0">
                  MarketPlace
                </Label>
                <Tabs defaultValue="Architecture" data-oid="c5.:2hn">
                  <TabsList
                    className="grid w-full grid-cols-3"
                    data-oid=".rar7sp"
                  >
                    <TabsTrigger value="Architecture" data-oid="b5vum6w">
                      Architecture
                    </TabsTrigger>
                    <TabsTrigger value="password" data-oid="d8igc1n">
                      CI/CD
                    </TabsTrigger>
                    <TabsTrigger value="Monitoring" data-oid="b:3cu3z">
                      Monitoring
                    </TabsTrigger>
                  </TabsList>
                  <TabsContent
                    ...
                    data-oid="vet6ysg"
                  >
                    <Card className=" mb-4 mr-1" data-oid="0_.so_m">
                      <CardHeader data-oid="00c1nye">
                        <div className="flex " data-oid="ur5ywcm">
                          <svg
                            className="h-8 w-12 "
                            role="img"
                            data-oid="ns7hwpa"
                          ...
                          <CardTitle data-oid="yd2f28j">
                            Kubernetes Dashboard
                          </CardTitle>
                        </div>

                        <CardDescription data-oid="r-ud9pb">
                          UI for managing K8S clusters.
                        </CardDescription>
                      </CardHeader>
                      <CardContent data-oid="-c.xoq7">
                        <div data-oid="qf6czxy">
                          <Label htmlFor="version" data-oid="tqrjcgb">
                            Version
                          </Label>
                          <Input
                            id="version"
                    ...
                    <Card className=" mx-1 mb-4" data-oid="ksnql4d">
                      <CardHeader data-oid="tado92o">
                        <div className="flex " data-oid="g-k8hmp">
                          <svg
                            className="h-8 w-12 "
                            role="img"
                            data-oid="1s-7k80"
                          ...
                          <CardTitle data-oid="solwtbv">
                            Istio Gateway
                          </CardTitle>
                        </div>
                        <CardDescription data-oid="h0p_.wp">
                          Service Mesh for K8S clusters.
                        </CardDescription>
                      </CardHeader>
                      <CardContent data-oid="drm75gl">
                        <div data-oid="0tc90.4">
                          <Label htmlFor="version" data-oid="1et9rzf">
                            Version
                          </Label>
                          <Input
                            id="version"
                    ...
                    <Card className=" mx-1 mb-4" data-oid="mqs.qnx">
                      <CardHeader data-oid="it39.6u">
                        <div className="flex " data-oid="8hyfri-">
                          <svg
                            className="h-8 w-12 "
                          ...
                          >
                            ...
                            >
                              ...
                              <path
                                d="M1415 2060 c-3 -6 1 -13 10 -16 19 -8 30 0 20 15 -8 14 -22 14 -30 1z"
                                data-oid="pnwu768"
                              />

                              <path
                                d="M1237 1662 c-35 -38 -8 -92 46 -92 27 0 57 32 57 61 0 43 -73 65 -103 31z"
                                data-oid="4o4ar0q"
                              />

                              <path
                                d="M1855 831 c-6 -11 9 -23 19 -14 9 9 7 23 -3 23 -6 0 -12 -4 -16 -9z"
                                data-oid="psxusah"
                              />

                              <path
                                d="M855 639 c-4 -6 -5 -12 -2 -15 2 -3 7 2 10 11 7 17 1 20 -8 4z"
                                data-oid="npeq2j7"
                              />

                              <path
                                d="M1504 576 c-7 -19 13 -56 31 -56 19 0 19 16 0 24 -22 8 -18 25 8 36 21 8 21 9 -6 9 -15 1 -30 -5 -33 -13z"
                                data-oid="o0_irnx"
                              />

                              <path
                                d="M1295 510 c-3 -5 -1 -10 4 -10 6 0 11 5 11 10 0 6 -2 10 -4 10 -3 0 -8 -4 -11 -10z"
                                data-oid="7cimo9p"
                              />
                            </g>
                          </svg>
                          {/*<svg className="h-8 w-12 " role="img" ><path d="M4 21 20 21 10 24zM4 20 10 19 10 8zM11 19 20 20 11 0z"/></svg>*/}
                          <CardTitle data-oid="2vu_x0_">Cert Manager</CardTitle>
                        </div>
                        <CardDescription data-oid="zm_mr0g">
                          k8s certificate management
                        </CardDescription>
                      </CardHeader>
                      <CardContent data-oid="77f1t6m">
                        <div data-oid="2qxmifj">
                          <Label htmlFor="version" data-oid="bn196_k">
                            Version
                          </Label>
                          <Input
                            id="version"
                    ...
                    <Card className=" mb-4 ml-1" data-oid=".rv935d">
                      <CardHeader data-oid="tq3jnlx">
                        <div className="flex " data-oid="uyzqs0h">
                          <svg
                            className="h-8 w-12 "
                            viewBox="0 0 16 16"
                            data-oid="yc5ohc7"
                          ...
                          <CardTitle data-oid=".-tft2d"> Vault</CardTitle>
                        </div>
                        <CardDescription data-oid=".mjuwdd">
                          protecting secrets and sensitive data.
                        </CardDescription>
                      </CardHeader>
                      <CardContent data-oid="4:rs.sg">
                        <div data-oid="mdqpufz">
                          <Label htmlFor="version" data-oid="pp9na:i">
                            Version
                          </Label>
                          <Input
                            id="version"
                    ...
                    <Card className=" mb-4 mr-1 " data-oid="q7ixi95">
                      <CardHeader data-oid="b58l8wp">
                        <div className="flex items-start" data-oid="ca.3aq7">
                          <svg
                            className="h-8 w-12 "
                            role="img"
                            data-oid="5kvjw85"
                          ...
                          <CardTitle data-oid="fpjq0ml">Minio </CardTitle>
                        </div>
                        <CardDescription data-oid="60f9hdp">
                          S3 compatible object storage server.
                        </CardDescription>
                      </CardHeader>
                      <CardContent data-oid="3gy0wpi">
                        <div data-oid="mecgtrb">
                          <Label htmlFor="version" data-oid="9bnzctj">
                            Version
                          </Label>
                          <Input
                            id="version"
                    ...
                    <Card className="invisible mx-1 mb-4" data-oid="7m6l4qh" />
                    <Card className="invisible mx-1 mb-4" data-oid="bbwn.9n" />
                    <Card className="invisible mb-4 ml-1" data-oid="j51v7v." />
                  </TabsContent>
                  <TabsContent value="password" data-oid="bewet-e">
                    <Card data-oid="512mll3">
                      <CardHeader data-oid="nm-k0e3">
                        <CardTitle data-oid="22l5wcz">Password</CardTitle>
                        <CardDescription data-oid="jqvu-h3">
                          Change your password here. After saving, you`&apos;`ll
                          be logged out.
                        </CardDescription>
                      </CardHeader>
                      <CardContent className="space-y-2" data-oid="b2r70h3">
                        <div className="space-y-1" data-oid="yax5_4y">
                          <Label htmlFor="current" data-oid="as9gzng">
                            Current password
                          </Label>
                          <Input
                            id="current"
                        ...
                        <div className="space-y-1" data-oid="huw2u9f">
                          <Label htmlFor="new" data-oid="_1ppo5f">
                            New password
                          </Label>
                          <Input id="new" type="password" data-oid="xpf1ox8" />
                        </div>
                      </CardContent>
                      <CardFooter data-oid="uh2x3y8">
                        <Button data-oid="8c8u03t">Save password</Button>
                      </CardFooter>
                    </Card>
                  </TabsContent>
                </Tabs>
          ...
          <div className="w-2/3 space-y-6 p-6 pt-0" data-oid="o21nkor">
            <Button type="submit" disabled={_isSaving} data-oid="xe98acv">
              {_isSaving && (
                <Icons.Spinner
